    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="sendmessage.php" method="post">
                ...
                <p><input type="text" class="form-control col-sm-5 mb-3 mb-sm-0" id="txtemailaddress" name="txtemailaddress" placeholder="Type a name or email address"></p>
                <p><input type="text" class="form-control col-sm-5 mb-3 mb-sm-0" id="txtsubject" name="txtsubject" placeholder="Subject"></p>
                <p><textarea class="form-control col-sm-5 mb-3 mb-sm-0" name="txtmessage" id="txtmessage" cols="30" rows="15" maxlength="5000" placeholder="Message"></textarea></p>
